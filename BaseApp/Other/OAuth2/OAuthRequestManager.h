...
#define  SINA_APP_KEY           @"4156390784"
#define  SINA_APP_SECRET        @"933cb9582d4fbb11f0a7dcb819dc1086"


#define  VDISK_V2_DOMAIN          @"https://"
#define  VDISK_API_AUTHORIZE      @"https://openapi.baidu.com/oauth/2.0/authorize"
#define  VDISK_APP_KEY            @"2600941871"
#define  VDISK_APP_SECRET         @"f8ab4a1835339e664839c236a4a509c9"
...
@protocol OAuthRequestManagerDelegate <NSObject>

@optional
-(void)didGetPublicTimelineWithStatues:(NSArray*)status;
...
@interface OAuthRequestManager : NSObject
{
    ...
    __unsafe_unretained id<OAuthRequestManagerDelegate>         delegate;
...
@property (nonatomic,assign)id<OAuthRequestManagerDelegate> delegate;
