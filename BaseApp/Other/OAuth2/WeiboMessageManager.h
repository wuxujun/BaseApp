...
@interface WeiboMessageManager : NSObject<OAuthRequestManagerDelegate>
{
    OAuthRequestManager         *requestManager;
}

@property (nonatomic,strong)OAuthRequestManager     *requestManager;
