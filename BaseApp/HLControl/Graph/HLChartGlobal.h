...
#define X_GRIDLINE_OFFSET_TOUCH 30.5
#define Y_GRIDLINE_OFFSET_TOUCH 15.5

#define BARCHART_X_PADDING 30
#define BARCHART_Y_PADDING 30
...
#define PIE_RADIUS  100
#define PIE_PI      3.1415927
